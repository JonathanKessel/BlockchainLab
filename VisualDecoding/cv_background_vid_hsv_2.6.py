...
out_stack = cv.VideoWriter('./Ergebnisse/2b_stack.mp4', cv.VideoWriter_fourcc('m', 'p', '4', 'v'), 10.0, (2020, 480))
out_mask = cv.VideoWriter('./Ergebnisse/2b_mask.mp4', cv.VideoWriter_fourcc('m', 'p', '4', 'v'), 25.0, (400, 480))
while True:
    ...
    if "diver" in boxes_dict:
        ...
        mask_diver_no_MOG2[np.where((mask_diver_no_MOG2 == [0, 0, 255]).all(axis=2))] = [255, 0, 255]  # (!!!)
    ...
    """
     mask_diver_no_MOG2[0:480, 0:150] = [0, 0, 0]
        ...
        mask_diver_no_MOG2[0:50, 0:680] = [0, 0, 0]
    """
    stack = cv.hconcat([frame_2a, mask_diver_no_MOG2_small, main_result, frame])
    print(mask_diver_no_MOG2_small.shape)
    out_mask.write(mask_diver_no_MOG2_small)
    # print(stack.shape)
